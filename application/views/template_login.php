...
<head>
    ...
    <title>COBA WEBSITE - Bootstrap 4 Admin Template</title>
...
<body>
    <div class="app">
        <div class="authentication">
            <div class="sign-in-2">
                <div class="container-fluid no-pdd-horizon bg" style="background-image: url('<?php echo base_url() ?>assets/dist/assets/images/others/img-27.jpg')">
                    <div class="card">
                        <div class="card-body">
                            <?php echo $contents ?>
                        </div>
