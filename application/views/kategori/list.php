...
<div class="col-md-12">
    <div class="card border-info text-dark">
        <div class="card-block">
            ...
            <p><code>Managemen Kategori:</code></p>
            <table>

            </table>
            <button data-toggle="modal" data-target="#modal-lg" class="btn btn-sm btn-success">TAMBAH KATEGORI</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <label for="form-1-2" class="col-md-4 control-label">NAMA KATEGORI<br><small>*Maximal 15 characters</small></label>
                    <div class="col-md-5">
