...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 15, 2021 at 07:13 AM
...
DROP TABLE IF EXISTS `tbl_beli_suplier`;
...
DROP TABLE IF EXISTS `tbl_chatbot`;
...
(1, 'Halo|hallo|hai|hay|hi|woy|', 'Oh, hai kawan'),
(2, 'Siapa kamu|Siapa kamu?', 'Saya hanya bot, anda bisa memanggil saya \"bot\"!'),
(3, 'Terimakasih|makasih', 'Sama-sama kawan'),
...
(24, 'Chatbot', '', 'Chatbot', 'ei-speech-box-dual', 0);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', 'administrasi'),
(2, 'sahid', '9f8b4c019d3b7bc89e82a85fbd0d4008', 1, '', 'sahid'),
(3, 'bos', '15fc4a53992beba40ae91e5244e79dff', 3, '', 'bos'),
(4, 'security', 'e91e6348157868de9dd8b25c81aebfb9', 5, '', 'security'),
(5, 'keuangan', 'a4151d4b2856ec63368a7c784b1f0a6e', 4, '', 'keuangan');
...
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `v_transaksi_laporan_penjualan`;
